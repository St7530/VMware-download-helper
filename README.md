...
**Tested products:** VMware Workstation, VMware Fusion, vSphere and vCenter

## How to use

1. Install [Tampermonkey](https://www.tampermonkey.net/) on your browser.
2. [Click this link](https://github.com/St7530/VMware-download-helper/raw/refs/heads/main/VMware-download-helper.user.js) to install the script in Tampermonkey.
...
1. Hook XHR
2. Delete the `exportControlStatus` field in HTTP response
